...
//               <Link href={proj.link} className="text-[#f97316] underline text-sm mt-3 inline-block">View Project →</Link>
//             </motion.div>
//           ))}
//         </div>
//       </section>
...
// const projects = [
//   { title: 'AI Blog Generator', desc: 'An AI-powered markdown blog creator using GPT-4.', link: '#' },
//   { title: 'Dev Portfolio Boilerplate', desc: 'A sleek Next.js portfolio setup for devs.', link: '#' },
//   { title: 'Tailwind CSS UI Kit', desc: 'Handcrafted UI kit with developer-focused components.', link: '#' },
// ];
'use client';
import { Flame, Code2, BrainCircuit, Github, Linkedin, Send } from 'lucide-react';
import Link from 'next/link';
